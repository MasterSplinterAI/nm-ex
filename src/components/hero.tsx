...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-5 pt-16 sm:px-10 sm:pb-10 sm:pt-20">
        <motion.p
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.55, ease: [0.16, 1, 0.3, 1] }}
          className="font-display text-[clamp(2rem,9vw,4.25rem)] leading-[0.9] tracking-[-0.04em] text-[var(--ink)]"
        >
          NM-EX
        </motion.p>
